...
public class CalendarExample {
	public static void main(String[] args) {
		...
		//Calender 클래스의 정적 메서드인 getInstance()메서드를 사용하면
		//컴퓨터에 설정되어있는 시간대를 기준으로 객체를 얻을 수 있다
		
		Calendar now = Calendar.getInstance();
		//Calender 가 제공하는 날짜와 시간에 대한 정보를 얻기위해선  get() 메서드를 사용한다
