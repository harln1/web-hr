...
//객체로 컨테이너에 저장해놓고 싶은 클래스에 @Component 
@Component class Car{};
...
class AppContext{
	...
	//컴포넌트 어노테이션이 붙어있는 클래스를 찾아서 객체를 만들고 맵에 저장하는 기법
...
public class Main3 {
	...
	public static void main(String[] args) {
		...
		Car car = (Car)ac.getBean("sportCar"); 
		System.out.println(car);
		

		System.out.println("전체 저장소 상태: " + ac.map);
	}
}